...
<div class="container d-flex justify-content-center align-items-center">
    <div class="d-inline">
        <div class="pb-4" style="font-weight: 600; font-size: 30px"><a href="/profile/{{$main->username}}" style="text-decoration: none; color: black">{{$main->username}}</a> is following:</div>
        <div class="d-inline">
